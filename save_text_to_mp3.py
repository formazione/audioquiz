...
al contrario del bilancio che è un documento consuntivo e non è obbligatorio.
...
al termine di ciascun periodo lo si analizza  e poi si aggiunge una nuova previsione per un altro periodo successivo all'ultimo
in modo da avere sempre un budget proiettato su un anno.
